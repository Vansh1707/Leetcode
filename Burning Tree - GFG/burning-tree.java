...
class Solution
{
    ...
    public static void burningTreeNode(Node root, int time,Node block, ArrayList<ArrayList<Integer>> ans){
  ...
  public static int burningTree(Node root, int data,ArrayList<ArrayList<Integer>> ans){
      if(root==null)return -1;
      if(root.data==data){
          burningTreeNode(root,0,null,ans);
          return 1;
      }
      int lt=burningTree(root.left,data,ans);
      if(lt!=-1){
          burningTreeNode(root,lt,root.left,ans);
          return lt+1;
      }
      int rt=burningTree(root.right,data,ans);
      if(rt!=-1){
